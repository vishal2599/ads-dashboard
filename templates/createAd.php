    ...
    <?php if (in_array('administrator', (array) $user->roles)) : ?>
        <a href="/wp-admin/admin.php?page=advertisers_dashboard" class="page-title-action ad-new-ad">
            <- Back to Ads Dashboard</a> <?php endif; ?> <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" name='adv_dashboard_form' enctype='multipart/form-data'>
                ...
                <div class="banner">
                    <div class="image">
                        <img width="300" src="<?php echo (!empty($data)) ? wp_get_attachment_url($data->banner_id) : ''; ?>" class="image" style="margin-top:10px;<?php echo (!empty($data)) ? '' : 'display:none;'; ?>" />
                    ...
                    <div class="url">
                        <input type='text' placeholder="Affiliate URL" name='affiliate_url' <?php echo (!empty($data)) ? 'value=' . $data->banner_url : ''; ?>>
                    </div>
                </div>
                <div class="in_story">
                    <div class="image">
                        <img width="300" src="<?php echo (!empty($data)) ? wp_get_attachment_url($data->in_story_id) : ''; ?>" class="image" style="margin-top:10px;<?php echo (!empty($data)) ? '' : 'display:none;'; ?>" />
                    ...
                    <div class="url">
                        <input type='text' placeholder="Affiliate URL" name='affiliate_url' <?php echo (!empty($data)) ? 'value=' . $data->in_story_url : ''; ?>>
                    </div>
                </div>
                <div class="footer">
                    <div class="image">
                        <img width="300" src="<?php echo (!empty($data)) ? wp_get_attachment_url($data->footer_id) : ''; ?>" class="image" style="margin-top:10px;<?php echo (!empty($data)) ? '' : 'display:none;'; ?>" />
                    ...
                    <div class="url">
                        <input type='text' placeholder="Affiliate URL" name='affiliate_url' <?php echo (!empty($data)) ? 'value=' . $data->footer_url : ''; ?>>
                    </div>
                </div>
                <div class="sidebar_one">
                    <div class="image">
                        <img width="300" src="<?php echo (!empty($data)) ? wp_get_attachment_url($data->sidebar_one_id) : ''; ?>" class="image" style="margin-top:10px;<?php echo (!empty($data)) ? '' : 'display:none;'; ?>" />
                    ...
                    <div class="url">
                        <input type='text' placeholder="Affiliate URL" name='affiliate_url' <?php echo (!empty($data)) ? 'value=' . $data->sidebar_one_url : ''; ?>>
                    </div>
                </div>
                <div class="sidebar_two">
                    <div class="image">
                        <img width="300" src="<?php echo (!empty($data)) ? wp_get_attachment_url($data->sidebar_two_id) : ''; ?>" class="image" style="margin-top:10px;<?php echo (!empty($data)) ? '' : 'display:none;'; ?>" />
                    ...
                    <div class="url">
                        <input type='text' placeholder="Affiliate URL" name='affiliate_url' <?php echo (!empty($data)) ? 'value=' . $data->sidebar_two_url : ''; ?>>
                    </div>
                </div>
